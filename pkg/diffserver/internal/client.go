...
// Copied from
// https://github.com/crossplane/crossplane/blob/b56f55c021a195ceb301e2ff6a937db014887e43/internal/render/client.go

// Package internal provides shared infrastructure for rendering Crossplane
...
// and label selector.
func (c *InMemoryClient) List(_ context.Context, list client.ObjectList, opts ...client.ListOption) error { //nolint:gocyclo // better maintained as a single function
