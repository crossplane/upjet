			...
			for _, cv := range changeReport.Versions {
				for _, change := range cv.Changes {
					...
					case crdschema.ChangeTypeTypeChanged:
						...
						switch {
						case crdschema.IsOfType(change.TypeChangeDetails.Deleted, "string") && crdschema.IsOfType(change.TypeChangeDetails.Added, "number"):
						...
						case crdschema.IsOfType(change.TypeChangeDetails.Deleted, "number") && crdschema.IsOfType(change.TypeChangeDetails.Added, "string"):
						...
						case crdschema.IsOfType(change.TypeChangeDetails.Deleted, "string") && crdschema.IsOfType(change.TypeChangeDetails.Added, "boolean"):
						...
						case crdschema.IsOfType(change.TypeChangeDetails.Deleted, "boolean") && crdschema.IsOfType(change.TypeChangeDetails.Added, "string"):
